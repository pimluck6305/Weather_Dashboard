...
คำตอบ : ได้เรียนรู้เกี่ยวกับการเขียนโปรแกรมด้วยpython การใช้APIต่างๆ การทำunit testเื่อทดสอบฟังก์ชั่นต่างๆ ได้ฝึกการสื่อสารโดยการเขียนREADMEให้เข้าใจง่ายขึ้น
